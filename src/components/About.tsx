...
export const About: React.FC = () => (
  <div className="py-10 text-center">
    ...
    <p className="text-lg">Leif Christian grew up in Paradise Valley, Montana, and is a lover of music, culture and the outdoors.  Leif has a background In audio software and construction, and transitioned into programming in 2018. Specializing in technologies like Node.js, Vue, React, React Native, Electron and all things JavaScript.{"\n"}
